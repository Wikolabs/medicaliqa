...
export const metadata: Metadata = { title:"MedicalIQA — Agent IA de Q&A medical et clinique", description:"Un assistant IA medical pour les professionnels de sante. MedicalIQA repond aux questions cliniques, analyse les symptomes et aide a la decision medicale avec des sources validees." };
